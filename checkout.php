        ...
        <div style="display: flex;flex-direction: column;width: 100%;margin: 10px;">
          <div style="border :1px solid black; border-radius: 10px; margin: 10px; padding: 10px; width: 100%;">
            ...
            <div style="display: flex; border:1px solid black;flex-direction: column;margin: 10px;padding: 10px;">
              <span style="font-weight: bolder;font-size: 50px;">Rp <?php echo $hargaBarangID; ?></span>
              ...
              <form method="POST" action="process.php?idbarang=<?php echo $idBarangID; ?>">
              <p>Jumlah yang mau dibeli <input type="number" name="jumlahdibeli"></p>
              <input type="submit" name="submit" value="total bayar">
              </form>
